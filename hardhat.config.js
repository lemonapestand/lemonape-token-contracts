...
function mnemonic() {
  try {
    return "0x5d7e506e785b427c3e33c210aad13aa756bd6c0a3e28b74280848cedc23bf00d";
  } catch (e) {
...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      ...
      accounts:["375e6ca744d8d73ca6400dc1ae82bcd78da8e0bdc866577aabad25387e1d4aa9"],
    },
    kovan: {
  ...
  etherscan: {
    apiKey: {
      ...
      bsc: "CC1XPKA425FSSZDZVXMAAVE16SFA99X9YG"
      // add other network's API key here
    },
  },
  bscscan: {
    apiKey: {
      bsctestnet: "CC1XPKA425FSSZDZVXMAAVE16SFA99X9YG",
      // add other network's API key here
    },
  },
};
